<div class="sectionsLogin iziModal" id="modal">
    <header class="headerLogin">
        <a href="#" id="login" class="active">Inicia Sesión</a>
        <a href="#" id="newAccount">Crear Cuenta</a>
    </header>
    <section class="login">
        <form id="login">
            <input id="userLogin" class="input100" type="text" name="user" placeholder="Usuario (E-mail)">
            <input id="passLogin" class="input100" type="password" name="pass" placeholder="Contraseña">
